export const practiceAreas = [
  {
    title: 'Familienrecht',
    description: 'Scheidung, Sorgerecht, Unterhalt und Kindesschutz: Unsere Anwälte für Familienrecht in Zürich stehen Ihnen mit Einfühlungsvermögen und Durchsetzungskraft zur Seite.',
    href: '/anwalt-fuer-familienrecht',
    icon: `<svg class="w-8 h-8 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>`,
  },
  {
    title: 'Strafrecht',
  ...
  {
    title: 'Arbeitsrecht',
    description: 'Kündigung, Arbeitszeugnis, Lohnforderungen und Mobbing: Unser Arbeitsrecht-Anwalt in Zürich prüft Ihre Rechte und vertritt Sie erfolgreich.',
    href: '/anwalt-fuer-arbeitsrecht',
  ...
  },
  {
    ...
    description: 'Grundstückkauf, Eigentumsrecht und Stockwerkeigentum: Rechtssichere Beratung für Immobilientransaktionen in Zürich und der ganzen Schweiz.',
    href: '/anwalt-fuer-immobilienrecht',
    icon: `<svg class="w-8 h-8 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>`,
  },
  {
